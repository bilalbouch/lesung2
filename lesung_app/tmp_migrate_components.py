...
files = [
    ...
    'lib/components/app_snackbars.dart',
    'lib/components/app_navigation_bar.dart',
    'lib/components/book_card.dart',
]

for filepath in files:
    if not os.path.exists(filepath):
        print(f'SKIP: {filepath} non trouve')
        continue
    ...
    # Supprimer imports lumina_colors si inutile
...
print('Migration composants terminee')
